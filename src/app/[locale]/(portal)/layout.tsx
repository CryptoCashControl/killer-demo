...
export const metadata: Metadata = {
  metadataBase: new URL('https://cckiller.com'),
  title: {
    default: "CC Killer - Professional FX Trader Training Platform | 军刀·外汇交易职业交易员培训",
    template: "%s | CC Killer"
  },
  description: "CC Killer (军刀) - 专注于外汇交易的职业交易员培训平台。提供系统化外汇交易培训、实战训练和资金支持。通过专业考核即可获得资金管理权限，分润比例高达90%。培养真正适合外汇市场的专业交易员。",
  keywords: [
    "CC Killer",
    "军刀",
    "外汇交易",
  ...
  alternates: {
    canonical: "https://cckiller.com",
    languages: {
      'zh-CN': 'https://cckiller.com/zh',
      'en-US': 'https://cckiller.com/en',
    },
  },
  openGraph: {
    type: "website",
    ...
    url: "https://cckiller.com",
    siteName: "CC Killer | 军刀",
    title: "CC Killer - Professional FX Trader Training Platform | 军刀·职业交易员培训",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "CC Killer - Professional FX Trader Training Platform",
        type: "image/jpeg",
      }
    ],
  },
  twitter: {
    ...
    site: "@cckiller",
    creator: "@cckiller",
    title: "CC Killer - Professional FX Trader Training Platform",
