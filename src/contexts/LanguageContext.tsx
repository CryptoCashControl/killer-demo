...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'footer.copyright': '© 军刀 · 专业外汇交易员培训平台 · cckiller.com',
    ...
    'faq.category.course': '关于 CC Killer',
    ...
    'donate.how.step2.desc': '邮件至 123@qq.com，说明您的意向',
    ...
    'dashboard.footer.copyright': '2024-2025 © CC Killer 专业外汇交易员培训平台',
    ...
    'blog.cta.subtitle': '加入CC Killer，接受专业的交易员培训',
    'blog.cta.button': '立即加入',
  },
  en: {
    // Brand Name
    'brand.name': 'CC Killer',
    'brand.full': 'CC Killer',
    ...
    // Why Choose Section
    'why.title': 'Why Choose CC Killer',
    ...
    'footer.copyright': '© CC Killer · Professional Forex Trader Training Platform · cckiller.com',
    ...
    'faq.category.course': 'About CC Killer',
    ...
    'donate.how.step2.desc': 'Email to 123@qq.com explaining your intention',
    ...
    'dashboard.footer.copyright': '2024-2025 © CC Killer Professional Forex Trader Training Platform',
    ...
    'blog.cta.subtitle': 'Join CC Killer for professional trader training',
