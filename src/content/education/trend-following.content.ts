...
export const trendFollowingContent = {
  zh: {
    title: '趋势跟踪完整指南 - Trend Following策略与EMA均线系统 | CC Killer',
    ...
    ctaTitle: '想要系统学习趋势交易？',
    ctaDescription: '加入 CC Killer 培训计划，获取专业趋势跟踪策略和趋势分析工具',
  ...
  en: {
    title: 'Complete Trend Following Guide - Strategies and EMA Moving Average System | CC Killer',
    ...
    ctaDescription: 'Join CC Killer training for professional trend following strategies and trend analysis tools',
